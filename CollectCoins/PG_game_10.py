# Добавим СуперМонету когда все собрали c. 21, 126, 61, 92
...
super_coin_image = pygame.image.load('images/supercoin.png')
super_coin_image.set_colorkey((255, 255, 255))  # убираем белый цвет


# Определяем звук для столкновения с монетой
coin_pickup_sound = pygame.mixer.Sound("images/soundCoin.wav")
...
class Coin:
    ...
    def drawsupercoin(self):
        screen.blit(super_coin_image, (self.x, self.y))
